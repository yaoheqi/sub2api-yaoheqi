export default {
    accounts: {
      ...
      openai: {
        ...
        codexFingerprintModeDesc: '多人共享同一 OAuth 账号时，将各用户的设备/会话标识收敛为账号级恒定值，减少上游可见的设备数和会话数。新建 OpenAI OAuth 账号默认使用“设备 + 会话”收敛；只有明确选择“关闭”才退出收敛。',
        codexFingerprintOff: '关闭（显式退出）',
