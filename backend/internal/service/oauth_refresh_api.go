...
// RefreshNow forces one provider refresh while preserving the same local and
// distributed locking, DB reread, credential versioning, and race recovery as
// the scheduled refresh path.
